export default function AboutMe() {
    return (
      <div>
        ...
        <p>
          The goal of this project is to build an easy, interactive platform where
          users can browse top-rated dishes, leave reviews, and help others
          discover great food around town. 
        </p>
  
        <p>
          Created by Sohan Karuturi.
        </p>
      </div>
    );
  }